...
public class TextActivity extends AppCompatActivity implements Callback<EnjoyEntity>, AbsListView.OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.activity_text_listView);

        Intent intent = getIntent();
        EnjoyEntity.ItemsEntity itemsEntity = (EnjoyEntity.ItemsEntity) intent.getSerializableExtra("textItem");
